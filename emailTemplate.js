...
const emailTemplate = (zone, Title) => `
...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: ${CONSTANTS.COLORS[zone]}">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: ${CONSTANTS.COLORS[zone]};width: 100%" cellpadding="0" cellspacing="0">
	...
	<div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 20px; padding-left: 20px; padding-top: 30px; padding-bottom: 30px;">
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="color: rgb(255, 255, 255); font-size: 34px; line-height: 40px;">${Title}</span></p></div>
	</div>
    ...
    <div><br><p style="margin: 0;font-size: 20px;line-height: 21px;text-align: center">Be fearful when others are greedy & greedy when others are fearful - Warren Buffett</p></div>
  </div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
